...
def remove_uncraftable_rows(df_recipes: pd.DataFrame, raw_materials_1_: Dict[str, float], raw_materials_2_: Dict[str, float], raw_materials_limit_1_: Dict[str, float], raw_materials_limit_2_: Dict[str, float]) -> Tuple[Dict[str, float], Dict[str, float], Dict[str, float], Dict[str, float], pd.DataFrame, Set[str]]:
    """
